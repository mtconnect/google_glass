...
class OAuthCodeExchangeHandler(OAuthBaseRequestHandler):
  ...
  def _perform_post_auth_tasks(self, userid, creds):
    ...
    if hostname.startswith('https://'):
      ...
      contact_body = {
          'id': 'MTConnect Glassware',
          'displayName': 'MTConnect Glassware',
          'imageUrls': [util.get_full_url(self, '/static/images/mtconnectglass.png')]
      }
    ...
    timeline_item_body = {
        'text': 'Welcome to MTConnect Glassware',
        'notification': {
            'level': 'DEFAULT'
        }
    }
